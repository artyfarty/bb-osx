...
ACLOCAL = /Users/artyfarty/work/bb-1.3.0/missing aclocal
AUTOCONF = autoconf
AUTOMAKE = /Users/artyfarty/work/bb-1.3.0/missing automake
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
AALIB_CFLAGS = -I/usr/local/Cellar/aalib/1.4rc4/include
AALIB_CONFIG = /usr/local/bin/aalib-config
AALIB_LIBS = -L/usr/local/Cellar/aalib/1.4rc4/lib -laa -lm -lncurses
CC = gcc
HAVE_MIKMOD = 
LIBMIKMOD_CFLAGS = 
LIBMIKMOD_CONFIG = no
...
CFLAGS = -g -O2 -I/usr/local/Cellar/aalib/1.4rc4/include -D SOUNDDIR=\"$(pkgdatadir)\"
bin_PROGRAMS = bb
...
CPPFLAGS = 
LDFLAGS = 
LIBS =  -L/usr/local/Cellar/aalib/1.4rc4/lib -laa -lm -lncurses
